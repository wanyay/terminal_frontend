...
const formSchema = z.object({
  ...
  hostEmployee: z.string().optional(),
...
export function VisitorEntryPage() {
  ...
  useEffect(() => {
    if (createVisitorEntry.isSuccess && !hasReset.current) {
      form.reset({
        visitorName: '',
        nrcOrPassport: '',
        phoneNumber: '',
    ...
    if (!createVisitorEntry.isSuccess) {
      hasReset.current = false
    }
  }, [createVisitorEntry.isSuccess, entryGates, form])

  function onSubmit(values: FormValues) {
    createVisitorEntry.mutate({
      visitorName: values.visitorName,
      nrcOrPassport: values.nrcOrPassport || undefined,
      phoneNumber: values.phoneNumber || undefined,
      companyName: values.companyName || undefined,
      purposeOfVisit: values.purposeOfVisit || undefined,
      hostEmployee: values.hostEmployee || undefined,
